...
// 3. Remove the line that ki the result of the naive algorithm, uncomment the
// line with a call to test_solution,
//    compile the program, and run it. This will ensure that your efficient
//    algorithm returns the same as the naive one for
//    small values of n.
...
// fibonacci_fast, and submit it to the grader.
